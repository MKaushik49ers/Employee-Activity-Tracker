<%@ Page Language="C#" MasterPageFile="~/DaySheetMaster.master" AutoEventWireup="true"  CodeFile="Default.aspx.cs" Inherits="_Default" %>
        ...
        <p>
            ...
            <table style="width: 94%">
                ...
                <tr>
                    ...
                    <td style="width: 20px; vertical-align: top; height: 47px; text-align: left;">
                    ...
                    <td style="width: 20px; height: 47px;">
                        </td>
                </tr>
                <tr>
