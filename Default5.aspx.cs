...
public partial class Default5 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd1 = new SqlCommand("select t1.ActivityName, sum(t2.ActivityDuration) ActivityDuration, t3.TeamName from tbl_Activity t1, tbl_ActivityDetails t2, tbl_Team t3, tbl_TescoCalender t4, tbl_UserDetails t5 where t1.ActivityID = t2.ActivityID and t2.TeamID = t3.TeamID and t2.Tesco_Date = t4.Tesco_Date and t3.TeamID = t5.TeamID and t4.Tesco_Week =" + Week + " and t4.Tesco_Year =" + Year + " and t4.Tesco_Period =" + Period + "and t3.TeamName in('" + ActivityTeams + "')Group by t3.TeamName,t1.ActivityName", connection);
